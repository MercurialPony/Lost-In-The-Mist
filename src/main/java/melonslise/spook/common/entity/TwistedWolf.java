...
public class TwistedWolf extends Monster implements ITwistedMob
{
	...
	{
		return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 8d).add(Attributes.MOVEMENT_SPEED, 0.3d);
	}
	...
	{
		this.playSound(SoundEvents.WOLF_STEP, 0.15f, 1f);
	}
}